...
struct zebra_evpn_access_bd {
	...
	/* presence of zevi activates the EVI on all the ESs in mbr_zifs */
	zebra_evi_t *zevi;
};
...
#define EVPN_MH_MAC_HOLD_TIME_DEF (18 * 60)
	time_t mac_hold_time;
#define EVPN_MH_NEIGH_HOLD_TIME_DEF (18 * 60)
	time_t neigh_hold_time;
};
...
extern void zebra_evpn_vni_es_init(zebra_evi_t *zevi);
extern void zebra_evpn_vni_es_cleanup(zebra_evi_t *zevi);
extern void zebra_evpn_vxl_vni_set(struct zebra_if *zif, zebra_evi_t *zevi,
				   bool set);
extern void zebra_evpn_es_set_base_vni(zebra_evi_t *zevi);
extern void zebra_evpn_es_clear_base_vni(zebra_evi_t *zevi);
...
extern void zebra_evpn_vni_update_all_es(zebra_evi_t *zevi);
